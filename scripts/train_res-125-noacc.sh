...
${python} -u ../run.py --step_per_iter=${step_per_iter} --id=${identifier} --layer_norm --difficulty=1 --reward=8 --fix_target --policy=${policy} --no_acc --net 256 256 256 \
       2>&1|tee ${log_dir} &\
